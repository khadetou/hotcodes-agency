  ...
  const teams = [
    {
      ...
      job: "CEO / Dévelopeur Full Stack",
      facebook: "https://www.facebook.com/khadetou",
      linkedIn: "https://www.linkedin.com/in/khadetou-dianifabe-776a00199/",
      twitter: "#",
      image: "/images/team/image-1.png",
    },
    {
      name: "Abdou Aziz Sy Dabakh Diop",
      job: "COO / Responsable du marketing numérique",
      facebook: "https://www.facebook.com/777673858king",
      linkedIn: "https://www.linkedin.com/in/khadetou-dianifabe-776a00199/",
      twitter: "#",
      image: "/images/team/image-2.jpeg",
    },
  ];
  return (
    <section id="team" className="a1P sm:a1Q lg:a1u[130px]">
      <div className="a1v xl:a1w">
        <ReactWOW animation="fadeInUp" delay="0.2s">
          <div className="ac a1B a2J a1C az md:a1U lg:a3p">
            <span className="title w-full"> {t("team.title")}</span>
            <h2 className="a1B a1I ae[620px] aE a1J a1G a1t dark:text-white sm:a1L md:a1F[50px] md:a3f[60px]">
              {t("team.subtitle")}
            </h2>
            <p className="a1B ae[620px] aF aG">{t("team.text")}</p>
          </div>
        </ReactWOW>
        <div className="a1R a5 a6 am">
          {teams.map(
            ({ name, job, facebook, linkedIn, twitter, image }, idx) => (
              <div key={idx} className="a4 a1v md:a1S/2 lg:a1S/4">
                <ReactWOW animation="fadeInUp" delay="0.2s">
                  <div className=" aJ a1B a1M ae[300px] az xs:ae[370px]">
                    <div className="ac a1E a2T aS">
                      <Image
                        ...
                        height={400}
                      />
                      <div className="duration-300 a1 a3E a2L/2 a2M/2 a3F aX aN group-hover:a1d group-hover:av">
                        <div className="a5 a9 am a3G">
                          <Link
                            href={facebook}
                            target="_blank"
                            aria-label="social-icon"
                            className="a5 a2o a2p a9 am a1j aT a2v a3l an a3c aI a3H aN hover:aZ hover:a16 hover:a3r"
                          >
                            <svg
                              width="20"
                              height="20"
                    ...
                    <div>
                      <h3 className="a3I aE a2Z a1K a1t dark:text-white sm:a1Y">
                        {name}
                      </h3>
                      <p className="font-heading aF aG">{job}</p>
                    </div>
                  </div>
                </ReactWOW>
              </div>
