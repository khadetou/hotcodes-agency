      ...
      <div className="a1v xl:a1w">
        ...
        <div className="a1R a5 a6 am">
          <div className="a4 a1v md:a1S/2 lg:a1S/3">
            <ReactWow animation="fadeInUp" delay="0.2s">
              <div className="aJ a1B a1M ae[380px] az md:a3q">
                <div className="a1B a1V a5 ah[70px] aR[70px] a9 am a1j a16 a3b aH aN group-hover:a16 group-hover:a3r group-hover:aI dark:bg-white dark:bg-opacity-5 dark:text-white dark:group-hover:a16 dark:group-hover:a3r md:a1X md:ah[90px] md:aR[90px]">
                  <svg
                    width="44"
                    height="44"
                    viewBox="0 0 44 44"
          ...
          <div className="a4 a1v md:a1S/2 lg:a1S/3">
            <ReactWow animation="fadeInUp" delay="0.35s">
              <div className="wow fadeInUp aJ a1B a1M ae[380px] az md:a3q">
                <div className="a1B a1V a5 ah[70px] aR[70px] a9 am a1j a16 a3b aH aN group-hover:a16 group-hover:a3r group-hover:aI dark:bg-white dark:bg-opacity-5 dark:text-white dark:group-hover:a16 dark:group-hover:a3r md:a1X md:ah[90px] md:aR[90px]">
                  <svg
                    width="44"
                    height="44"
          ...
          <div className="a4 a1v md:a1S/2 lg:a1S/3">
            <ReactWow animation="fadeInUp" delay="0.45s">
              <div className=" aJ a1B ae[380px] az md:a3q">
                <div className="a1B a1V a5 ah[70px] aR[70px] a9 am a1j a16 a3b aH aN group-hover:a16 group-hover:a3r group-hover:aI dark:bg-white dark:bg-opacity-5 dark:text-white dark:group-hover:a16 dark:group-hover:a3r md:a1X md:ah[90px] md:aR[90px]">
                  <svg
                    width="44"
                    height="44"
