    ...
    <section id="about" className="a1P sm:a1Q lg:a1u[130px]">
      <div className="a1v xl:a1w">
        ...
        <ReactWOW animation="fadeInUp" delay="0.3s">
          <Tabs
            className=" ac a2w a2T aS aU a3t a3u md:a33[70px] md:a1A[70px] lg:a33[60px] lg:a1A[60px] xl:a33[70px] xl:a1A[70px]"
            selectedTabClassName="!text-blue-color dark:!text-white !border-blue-color dark:!border-blue-color"
          >
            <div
                    ...
                    <div className="ac a3h a2O text-blue-color h-[490px] ae[600px] lg:a2g">
                      ...
                      <div className="a1 a29 a1a/2 a2w a1c/2">
                        <Image
                          ...
                          height={396}
                        />
                        <div className="a1 a3z a3A a2D a2a a4 aT a28 a3l a16 a3b a3m[6px] dark:border-white dark:border-opacity-10 dark:bg-white dark:bg-opacity-10"></div>
                      </div>
