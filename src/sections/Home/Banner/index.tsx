...
const Banner = () => {
  return (
    <section
      id="home"
      className="pt-28 relative z-40 overflow-hidden pb-24 sm:pt-36 lg:pt-[170px] lg:pb-[120px]"
    >
      <div className="px-4 w-full mx-auto xl:max-w-[1320px]">
        <div className="-mx-4 flex flex-wrap items-center">
            ...
            <div className="mx-auto mb-12 max-w-[530px] text-center lg:ml-0 lg:mb-0 lg:text-left ">
              ...
              <ReactWow animation="fadeInUp" duration="0.5s">
                <div className=" a5 a6 a9 am lg:as">
                  ...
                  <a
                    href="#about"
                    className="aD a9 aS a1N[14px] aU aE aF a1t hover:text-blue-color dark:text-white dark:hover:text-blue-color"
                  >
                    <span className="a2H">
                      <svg
                        width="24"
          ...
          <div className="w-full px-3 lg:w-1/2">
            <ReactWow animation="fadeInRight" duration="0.3s">
